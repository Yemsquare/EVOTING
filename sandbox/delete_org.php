        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="add_org.php"><span class="glyphicon glyphicon-plus-sign"></span>Add Association</a></li>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_GET['id'])) {
                    ...
                    echo "<div class='alert alert-danger'>Are you sure you want to delete selected Association? <a href='./delete_org.php?del_id=$org_id'>Yes</a> | <a href='./add_org.php'>No</a></div>";
                }
